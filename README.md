...
1. We generated the original bipartite graphs in Python for instances with |U| = |W| = n number of nodes equal to \(2^{10}\), where i = 5, 6, ..., 15 and having five different densities: p = 0.80, 0.85, 0.90, 0.95, and 0.98.
